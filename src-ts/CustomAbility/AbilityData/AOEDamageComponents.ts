...
export const AOEDamageComponents = [
  ...
  },
  {
    ...
    damageData: {
      // 0.72
      multiplier: BASE.KAME_EXPLOSION * 7.2,
      attribute: bj_HEROSTAT_INT,
      attackType: 6,
      damageType: 4,
      weaponType: 0,
  ...
  // detroit smash
  {
    ...
    maxDamageTicks: AOEDamage.UNLIMITED_DAMAGE_TICKS,
    damageData: {
      multiplier: BASE.DFIST_EXPLOSION * 0.82,
      attribute: bj_HEROSTAT_STR,
      attackType: 6,
      damageType: 4,
      weaponType: 0,
