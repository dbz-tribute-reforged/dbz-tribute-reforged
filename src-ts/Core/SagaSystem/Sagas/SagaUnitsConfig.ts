...
export const sagaUnitsConfig = new Map<string, SagaUnit>(
  [
    ...
    // namek saga
    ["Dodoria", new SagaUnit(FourCC("U015"), 15, 250, 150, 200, new Vector2D(8800, 1400))],
    ["Zarbon", new SagaUnit(FourCC("U016"), 17, 300, 300, 250, new Vector2D(8800, 1400))],
    ["Zarbon 2", new SagaUnit(FourCC("U01B"), 18, 500, 300, 250, new Vector2D(8800, 1400))],

    // ginyu force
    ["Guldo", new SagaUnit(FourCC("U00Y"), 20, 200, 200, 600, new Vector2D(8800, 1400))],
    ["Recoome", new SagaUnit(FourCC("U005"), 22, 600, 200, 300, new Vector2D(8800, 1400))],
    ["Burter", new SagaUnit(FourCC("U00Z"), 23, 200, 600, 350, new Vector2D(8800, 1400))],
    ["Jeice", new SagaUnit(FourCC("U010"), 23, 600, 250, 600, new Vector2D(8800, 1400))],
    ["Ginyu", new SagaUnit(FourCC("U000"), 25, 700, 250, 650, new Vector2D(8800, 1400))],
