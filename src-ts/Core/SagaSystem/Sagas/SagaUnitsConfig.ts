...
export const sagaUnitsConfig = new Map<string, SagaUnit>(
  [
    ...
    // turles
    ["Turles", new SagaUnit(FourCC("H01H"), 25, 300, 250, 300, new Vector2D(-3000, 11000))],

    // slug
    ["Lord Slug", new SagaUnit(FourCC("O00L"), 27, 600, 300, 500, new Vector2D(8700, -5400))],
    ...
    // ginyu force
    ["Guldo", new SagaUnit(FourCC("U00Y"), 18, 200, 200, 650, new Vector2D(8800, 1400))],
    ...
    ["Frieza 2", new SagaUnit(FourCC("U012"), 30, 1000, 300, 800, new Vector2D(8800, 1400))],
    ["Frieza 3", new SagaUnit(FourCC("U013"), 40, 1100, 350, 850, new Vector2D(8800, 1400))],
    ["Frieza 4", new SagaUnit(FourCC("U014"), 50, 1200, 400, 1300, new Vector2D(8800, 1400))],
    ["Frieza 5", new SagaUnit(FourCC("U018"), 60, 1500, 400, 1600, new Vector2D(8800, 1400))],

    // garlic jr
    ["Garlic Jr 2", new SagaUnit(FourCC("U00D"), 22, 800, 350, 850, new Vector2D(6000, 22500))],
    ["Salt", new SagaUnit(FourCC("U00E"), 15, 500, 300, 600, new Vector2D(6292, 22000))],
    ["Vinegar", new SagaUnit(FourCC("U00F"), 15, 500, 300, 600, new Vector2D(5861, 21285))],
    ["Mustard", new SagaUnit(FourCC("U00G"), 15, 600, 300, 500, new Vector2D(5860, 21638))],
    ["Spice", new SagaUnit(FourCC("U00H"), 15, 600, 300, 500, new Vector2D(5500, 22000))],
    ...
    // trunks saga
    ["Mecha Frieza", new SagaUnit(FourCC("U00J"), 33, 2200, 410, 1000, new Vector2D(18000, 2000))],
    ["King Cold", new SagaUnit(FourCC("U00K"), 33, 2200, 410, 2000, new Vector2D(18000, 2000))],
    ...
    ["Future Android 17", new SagaUnit(FourCC("H05C"), 34, 2800, 350, 2000, new Vector2D(17500, -6800))],
    ["Future Android 18", new SagaUnit(FourCC("H05D"), 34, 2000, 350, 2700, new Vector2D(17500, -6800))],

    // future cell saga
    ["Future Imperfect Cell", new SagaUnit(FourCC("H00E"), 39, 3300, 400, 3300, new Vector2D(-7000, -3000))],

    // broly - lss
    ["Broly DBZ 1", new SagaUnit(FourCC("H00M"), 33, 2500, 400, 2500, new Vector2D(8500, 4000))],

    // bojack unbound
    ["Bojack", new SagaUnit(FourCC("U00L"), 50, 6500, 400, 5500, new Vector2D(-4500, 2500))],
    ["Bido", new SagaUnit(FourCC("U00M"), 25, 2500, 400, 2500, new Vector2D(-4600, 2500))],
    ["Gokua", new SagaUnit(FourCC("U00N"), 30, 3500, 400, 3500, new Vector2D(-4700, 2100))],
    ["Pujin", new SagaUnit(FourCC("U00O"), 25, 3000, 400, 3000, new Vector2D(-4200, 2100))],
    ["Zangya", new SagaUnit(FourCC("U00P"), 30, 4000, 400, 3500, new Vector2D(-4600, 3000))],
    ...
    // fusion reborn
    ["Janemba", new SagaUnit(FourCC("H061"), 60, 11000, 400, 11000, new Vector2D(8500, 4000))],
    ["Super Janemba", new SagaUnit(FourCC("U007"), 90, 15000, 400, 15000, new Vector2D(8500, 4000))],

    // super buu saga
    ["Super Buu", new SagaUnit(FourCC("O006"), 80, 13000, 400, 13000, new Vector2D(-3000, 10000))],

    // kid buu saga
    ["Kid Buu", new SagaUnit(FourCC("O00C"), 90, 15000, 400, 15000, new Vector2D(5000, 9300))],
    ...
    ["Mature Hirudegarn", new SagaUnit(FourCC("U00C"), 90, 15000, 400, 15000, new Vector2D(-6700, -6700))],
    ...
    ["Bebi Golden Oozaru", new SagaUnit(FourCC("H01L"), 110, 19000, 400, 19000, new Vector2D(-6000, -5500))],

    // super 17 saga
    // hell fighter 17
    ["Super 17", new SagaUnit(FourCC("H05B"), 117, 17000, 400, 17000, new Vector2D(15000, 17000))],
    ...
    // beerus
    ["Beerus", new SagaUnit(FourCC("U01F"), 100, 18000, 400, 18000, new Vector2D(5000, 3300))],
    // possibly spawn in pilaf

    // possible whis training saga?
    // whis E01I
    ["Whis", new SagaUnit(FourCC("E01I"), 110, 22000, 400, 22000, new Vector2D(5000, 3300))],
