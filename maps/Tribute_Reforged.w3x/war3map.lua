...
function CreateNeutralHostile()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6253.3, 1739.8, 201.935, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6288.7, 1740.1, 84.630, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6268.1, 1583.7, 267.459, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6140.4, 1444.3, 109.977, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6033.8, 1365.4, 133.444, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 5937.3, 1326.5, 298.826, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 5911.6, 1287.9, 286.477, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 5959.4, 1140.8, 220.491, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6016.9, 1043.4, 248.167, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6040.1, 925.1, 329.281, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6036.7, 784.0, 125.380, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6001.9, 616.3, 276.040, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6017.5, 448.5, 103.890, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6072.1, 298.9, 289.729, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6130.7, 184.5, 55.428, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6143.9, 141.8, 11.932, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6252.9, 284.8, 310.395, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6291.4, 156.4, 352.837, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6260.5, 214.1, 158.362, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 6219.5, 306.6, 104.692, FourCC("n020"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01A"), 19023.8, -7245.6, 315.482, FourCC("n01A"))
    u = BlzCreateUnitWithSkin(p, FourCC("n01A"), 1529.8, -3044.4, 315.482, FourCC("n01A"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 13703.0, 11650.4, 218.569, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 13765.5, 11773.8, 291.575, FourCC("n020"))
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 13743.0, 11895.3, 175.292, FourCC("n020"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n020"), 16967.1, 10152.9, 214.987, FourCC("n020"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n019"), 8612.0, -7566.5, 246.343, FourCC("n019"))
    u = BlzCreateUnitWithSkin(p, FourCC("n03B"), 4275.7, 18510.6, 251.645, FourCC("n03B"))
    SetUnitColor(u, ConvertPlayerColor(8))
    u = BlzCreateUnitWithSkin(p, FourCC("n019"), 1314.1, -3371.4, 46.188, FourCC("n019"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n019"), -6369.2, 12029.2, 196.156, FourCC("n019"))
    u = BlzCreateUnitWithSkin(p, FourCC("n019"), -6407.5, 13092.9, 180.093, FourCC("n019"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n02E"), 8420.0, -7037.0, 226.666, FourCC("n02E"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 14509.4, 3812.4, 285.466, FourCC("n01E"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 15480.6, 1702.1, 31.279, FourCC("n01E"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 14972.2, -1798.1, 165.349, FourCC("n01E"))
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 16478.8, -1376.9, 340.663, FourCC("n01E"))
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 17263.8, -1854.8, 258.890, FourCC("n01E"))
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 17085.4, -2959.9, 174.248, FourCC("n01E"))
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 16026.0, -3387.6, 251.199, FourCC("n01E"))
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 15563.2, -2710.4, 36.630, FourCC("n01E"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 20089.2, -3269.3, 303.880, FourCC("n01E"))
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 18591.1, -2448.6, 347.288, FourCC("n01E"))
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 19270.8, -1951.5, 317.866, FourCC("n01E"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01E"), 20073.2, 1965.1, 237.312, FourCC("n01E"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n03G"), 18680.5, -7532.8, 268.800, FourCC("n03G"))
    ...
    SetUnitColor(u, ConvertPlayerColor(8))
    u = BlzCreateUnitWithSkin(p, FourCC("n014"), 20713.3, -3073.9, 143.079, FourCC("n014"))
    SetUnitColor(u, ConvertPlayerColor(8))
    ...
    SetUnitColor(u, ConvertPlayerColor(8))
    u = BlzCreateUnitWithSkin(p, FourCC("n031"), 10661.5, 16948.3, 250.166, FourCC("n031"))
    SetUnitColor(u, ConvertPlayerColor(12))
    ...
    SetUnitColor(u, ConvertPlayerColor(0))
    u = BlzCreateUnitWithSkin(p, FourCC("H000"), 254.2, 21412.3, 95.869, FourCC("H000"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n02F"), 3242.0, 14554.7, 274.848, FourCC("n02F"))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01D"), 16858.2, 1406.1, 254.550, FourCC("n01D"))
    ...
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("n02C"), 22996.3, 23354.6, 147.088, FourCC("n02C"))
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("n02C"), 22572.3, 22427.5, 329.882, FourCC("n02C"))
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("U01L"), -1710.1, 21310.3, 140.040, FourCC("U01L"))
    u = BlzCreateUnitWithSkin(p, FourCC("n02C"), 22628.2, 21521.1, 286.807, FourCC("n02C"))
    SetUnitColor(u, ConvertPlayerColor(12))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("n01X"), 23330.3, 23443.2, 244.703, FourCC("n01X"))
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("n01X"), 21472.7, 21887.0, 25.621, FourCC("n01X"))
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("n01X"), 21829.5, 21456.0, 44.270, FourCC("n01X"))
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("n02J"), 21648.7, 21731.0, 34.509, FourCC("n02J"))
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("n01X"), 23732.1, 23016.2, 244.703, FourCC("n01X"))
    SetUnitColor(u, ConvertPlayerColor(12))
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("N00C"), 23678.1, 23406.6, 230.767, FourCC("N00C"))
    SetUnitColor(u, ConvertPlayerColor(8))
end
...
function CreateNeutralPassive()
    ...
    u = BlzCreateUnitWithSkin(p, FourCC("H08K"), -251.7, 21658.3, 267.511, FourCC("H08K"))
    ...
    SetUnitColor(u, ConvertPlayerColor(11))
    u = BlzCreateUnitWithSkin(p, FourCC("h077"), 21431.9, 21414.2, 34.228, FourCC("h077"))
    SetUnitColor(u, ConvertPlayerColor(11))
    ...
    SetUnitColor(u, ConvertPlayerColor(12))
    u = BlzCreateUnitWithSkin(p, FourCC("n00V"), 600.9, 21482.7, 211.320, FourCC("n00V"))
    u = BlzCreateUnitWithSkin(p, FourCC("n00U"), 737.0, 21476.7, 251.792, FourCC("n00U"))
    u = BlzCreateUnitWithSkin(p, FourCC("n00W"), 482.4, 21486.6, 181.610, FourCC("n00W"))
    u = BlzCreateUnitWithSkin(p, FourCC("n00X"), 707.3, 21649.8, 32.070, FourCC("n00X"))
    u = BlzCreateUnitWithSkin(p, FourCC("O005"), 541.9, 21834.0, 168.606, FourCC("O005"))
    u = BlzCreateUnitWithSkin(p, FourCC("O006"), 698.5, 21907.4, 258.173, FourCC("O006"))
...
function CreateRegions()
    ...
    gg_rct_HeavenLeave = Rect(-6720.0, 21952.0, -6432.0, 22272.0)
    gg_rct_HellLeave = Rect(-1760.0, 21920.0, -1472.0, 22240.0)
    gg_rct_LookoutEntrance = Rect(5152.0, 3776.0, 5344.0, 3936.0)
    ...
    we = AddWeatherEffect(gg_rct_LowerHells, FourCC("FDrh"))
    EnableWeatherEffect(we, true)
...
function Trig_Buu_Candy_Auto_Attack_Actions()
    ...
    udg_TempInt = GetUnitAbilityLevelSwapped(FourCC("A0EI"), udg_TempUnit2)
    udg_TempLoc = GetUnitLoc(udg_TempUnit)
...
function Trig_Buu_Candy_Gobbler_Func008002003001()
    return (IsUnitAliveBJ(GetFilterUnit()) == true)
end

function Trig_Buu_Candy_Gobbler_Func008002003002001()
    return (UnitHasBuffBJ(GetFilterUnit(), FourCC("B01O")) == true)
end

function Trig_Buu_Candy_Gobbler_Func008002003002002()
    return (IsUnitEnemy(GetFilterUnit(), GetTriggerPlayer()) == true)
end

function Trig_Buu_Candy_Gobbler_Func008002003002()
    return GetBooleanAnd(Trig_Buu_Candy_Gobbler_Func008002003002001(), Trig_Buu_Candy_Gobbler_Func008002003002002())
end

function Trig_Buu_Candy_Gobbler_Func008002003()
    return GetBooleanAnd(Trig_Buu_Candy_Gobbler_Func008002003001(), Trig_Buu_Candy_Gobbler_Func008002003002())
end

function Trig_Buu_Candy_Gobbler_Func009A()
...
function Trig_Buu_Candy_Eating_Actions()
    SetUnitLifePercentBJ(udg_TempUnit2, (GetUnitLifePercent(udg_TempUnit2) + (0.30 * I2R(udg_TempInt))))
    if (Trig_Buu_Candy_Eating_Func002C()) then
        udg_StatMultUnit = udg_TempUnit2
        udg_StatMultReal = ((0.05 + (0.05 * I2R(udg_TempInt))) * I2R(GetUnitFoodMade(udg_TempUnit)))
        ...
        UnitDamageTargetBJ(udg_TempUnit2, udg_TempUnit, (GetUnitStateSwap(UNIT_STATE_MAX_LIFE, udg_TempUnit) * ((0.01 * 0.50) * I2R(udg_TempInt))), ATTACK_TYPE_HERO, DAMAGE_TYPE_NORMAL)
    end
end
...
function Trig_Player_Hero_Killed_Func001C()
    if (not (IsUnitType(GetKillingUnitBJ(), UNIT_TYPE_HERO) == true)) then
        return false
    end
    return true
...
function Trig_Player_Hero_Killed_Actions()
...
function InitTrig_Player_Hero_Killed()
    gg_trg_Player_Hero_Killed = CreateTrigger()
    TriggerRegisterAnyUnitEventBJ(gg_trg_Player_Hero_Killed, EVENT_PLAYER_UNIT_DEATH)
    TriggerAddCondition(gg_trg_Player_Hero_Killed, Condition(Trig_Player_Hero_Killed_Conditions))
    TriggerAddAction(gg_trg_Player_Hero_Killed, Trig_Player_Hero_Killed_Actions)
end
...
function Trig_FloatingText_TempString_to_TempPlayerGroup_at_TempLoc_Actions()
    ...
    SetTextTagLifespanBJ(udg_TempFloatingText, 2.50)
...
function Trig_Lower_Hells_Init_Actions()
    udg_LowerHellLoc = GetRectCenter(gg_rct_LowerHells)
    udg_LowerHellHeavenLoc = GetRectCenter(gg_rct_LowerHellsHeavenEnter)
    udg_LowerHellHellLoc = GetRectCenter(gg_rct_LowerHellsHellEnter)
    udg_LowerHellSagaLoc = GetRectCenter(gg_rct_LowerHellsSagaSpawn)
    udg_LowerHellSagaCurrentIndex = 0
    udg_LowerHellSagaMaxIndex = 0
    CreateTextTagLocBJ("TRIGSTR_9956", udg_LowerHellLoc, 0, 20.00, 100, 100, 100, 0)
    udg_TempFloatingText = GetLastCreatedTextTag()
    SetTextTagPermanentBJ(udg_TempFloatingText, true)
    udg_TempLoc = GetRectCenter(gg_rct_LowerHellsLeave)
    CreateTextTagLocBJ("TRIGSTR_9957", udg_TempLoc, 0, 10, 100, 100, 100, 0)
    udg_TempFloatingText = GetLastCreatedTextTag()
    SetTextTagPermanentBJ(udg_TempFloatingText, true)
        RemoveLocation(udg_TempLoc)
    udg_TempLoc = GetRectCenter(gg_rct_HeavenToLowerHell)
    CreateTextTagLocBJ("TRIGSTR_9958", udg_TempLoc, 0, 10, 100, 100, 100, 0)
    udg_TempFloatingText = GetLastCreatedTextTag()
    SetTextTagPermanentBJ(udg_TempFloatingText, true)
        RemoveLocation(udg_TempLoc)
    udg_TempLoc = GetRectCenter(gg_rct_HellToLowerHell)
    CreateTextTagLocBJ("TRIGSTR_9959", udg_TempLoc, 0, 10, 100, 100, 100, 0)
    udg_TempFloatingText = GetLastCreatedTextTag()
    SetTextTagPermanentBJ(udg_TempFloatingText, true)
        RemoveLocation(udg_TempLoc)
    udg_LowerHellSagaStats[udg_LowerHellSagaMaxIndex] = 5.00
    udg_LowerHellSagaMaxIndex = (udg_LowerHellSagaMaxIndex + 1)
end

function InitTrig_Lower_Hells_Init()
    gg_trg_Lower_Hells_Init = CreateTrigger()
    TriggerRegisterTimerEventSingle(gg_trg_Lower_Hells_Init, 5.00)
    TriggerAddAction(gg_trg_Lower_Hells_Init, Trig_Lower_Hells_Init_Actions)
end

function Trig_Move_Hero_To_Lower_Hell_Conditions()
    if (not (IsUnitType(GetTriggerUnit(), UNIT_TYPE_HERO) == true)) then
        return false
    end
    if (not (IsPlayerInForce(GetOwningPlayer(GetTriggerUnit()), udg_ActivePlayerGroup) == true)) then
...
function Trig_Move_Hero_To_Lower_Hell_Func006C()
...
function Trig_Move_Hero_To_Lower_Hell_Actions()
    udg_TempUnit = GetTriggerUnit()
        udg_ID = GetHandleId(udg_TempUnit)
    SaveIntegerBJ(2, 1, udg_ID, udg_HeroRespawnHashtable)
    if (Trig_Move_Hero_To_Lower_Hell_Func006C()) then
        udg_TempLoc = udg_LowerHellHeavenLoc
    else
        udg_TempLoc = udg_LowerHellHellLoc
    end
        SetUnitPosition(udg_TempUnit, GetLocationX(udg_TempLoc), GetLocationY(udg_TempLoc))
    udg_TempLoc = GetUnitLoc(udg_TempUnit)
    PanCameraToTimedLocForPlayer(GetTriggerPlayer(), udg_TempLoc, 0)
        RemoveLocation(udg_TempLoc)
end

function InitTrig_Move_Hero_To_Lower_Hell()
    gg_trg_Move_Hero_To_Lower_Hell = CreateTrigger()
    TriggerRegisterEnterRectSimple(gg_trg_Move_Hero_To_Lower_Hell, gg_rct_HeavenToLowerHell)
    TriggerRegisterEnterRectSimple(gg_trg_Move_Hero_To_Lower_Hell, gg_rct_HellToLowerHell)
    TriggerAddCondition(gg_trg_Move_Hero_To_Lower_Hell, Condition(Trig_Move_Hero_To_Lower_Hell_Conditions))
    TriggerAddAction(gg_trg_Move_Hero_To_Lower_Hell, Trig_Move_Hero_To_Lower_Hell_Actions)
end

function Trig_Hero_Enters_Lower_Hell_Respawn_Conditions()
    if (not (IsUnitType(GetTriggerUnit(), UNIT_TYPE_HERO) == true)) then
        return false
    end
    if (not (IsPlayerInForce(GetOwningPlayer(GetTriggerUnit()), udg_ActivePlayerGroup) == true)) then
...
function Trig_Hero_Enters_Lower_Hell_Respawn_Actions()
    udg_HeroRespawnUnit = GetTriggerUnit()
    udg_TempPlayer = GetOwningPlayer(GetTriggerUnit())
    ConditionalTriggerExecute(gg_trg_Hero_Respawn_To_Earth)
end

function InitTrig_Hero_Enters_Lower_Hell_Respawn()
    gg_trg_Hero_Enters_Lower_Hell_Respawn = CreateTrigger()
    TriggerRegisterEnterRectSimple(gg_trg_Hero_Enters_Lower_Hell_Respawn, gg_rct_LowerHellsLeave)
    TriggerAddCondition(gg_trg_Hero_Enters_Lower_Hell_Respawn, Condition(Trig_Hero_Enters_Lower_Hell_Respawn_Conditions))
    TriggerAddAction(gg_trg_Hero_Enters_Lower_Hell_Respawn, Trig_Hero_Enters_Lower_Hell_Respawn_Actions)
end

function Trig_Add_Unit_to_Lower_Hell_Saga_Queue_Actions()
    udg_LowerHellSagaUnit[udg_LowerHellSagaMaxIndex] = udg_TempUnit
    udg_LowerHellSagaStats[udg_LowerHellSagaMaxIndex] = (udg_SagaCompletedStatReward * 0.50)
    TriggerExecute(gg_trg_Revive_and_Move_Unit_to_HeroInit)
    udg_LowerHellSagaMaxIndex = (udg_LowerHellSagaMaxIndex + 1)
end

function InitTrig_Add_Unit_to_Lower_Hell_Saga_Queue()
    gg_trg_Add_Unit_to_Lower_Hell_Saga_Queue = CreateTrigger()
    TriggerAddAction(gg_trg_Add_Unit_to_Lower_Hell_Saga_Queue, Trig_Add_Unit_to_Lower_Hell_Saga_Queue_Actions)
end

function Trig_Lower_Hell_Saga_Unit_Dies_Conditions()
    if (not (GetTriggerUnit() == udg_LowerHellSagaUnit[udg_LowerHellSagaCurrentIndex])) then
        return false
    end
    return true
end

function Trig_Lower_Hell_Saga_Unit_Dies_Actions()
    udg_TempUnit = GetTriggerUnit()
    udg_SagaCompletedLoc = GetUnitLoc(udg_TempUnit)
    udg_SagaCompletedStatReward = udg_LowerHellSagaStats[udg_LowerHellSagaCurrentIndex]
    udg_SagaCompletedPlayer = GetOwningPlayer(GetKillingUnitBJ())
    ConditionalTriggerExecute(gg_trg_Saga_Stat_Reward)
    DisplayTextToForce(GetPlayersAll(), ("The lower hells have been purged of " .. (GetHeroProperName(udg_TempUnit) .. ((" by " .. udg_PlayerColorString[GetConvertedPlayerId(udg_SagaCompletedPlayer)]) .. (GetPlayerName(udg_SagaCompletedPlayer) .. "|r")))))
    TriggerSleepAction(5.00)
    udg_TempUnit = GetTriggerUnit()
    TriggerExecute(gg_trg_Revive_and_Move_Unit_to_HeroInit)
    udg_LowerHellSagaCurrentIndex = ModuloInteger((udg_LowerHellSagaCurrentIndex + 1), udg_LowerHellSagaMaxIndex)
    StartTimerBJ(udg_LowerHellSagaTimer, false, 25.00)
end

function InitTrig_Lower_Hell_Saga_Unit_Dies()
    gg_trg_Lower_Hell_Saga_Unit_Dies = CreateTrigger()
    TriggerRegisterAnyUnitEventBJ(gg_trg_Lower_Hell_Saga_Unit_Dies, EVENT_PLAYER_UNIT_DEATH)
    TriggerAddCondition(gg_trg_Lower_Hell_Saga_Unit_Dies, Condition(Trig_Lower_Hell_Saga_Unit_Dies_Conditions))
    TriggerAddAction(gg_trg_Lower_Hell_Saga_Unit_Dies, Trig_Lower_Hell_Saga_Unit_Dies_Actions)
end

function Trig_Revive_and_Move_Unit_to_HeroInit_Func001C()
...
function Trig_Revive_and_Move_Unit_to_HeroInit_Actions()
    if (Trig_Revive_and_Move_Unit_to_HeroInit_Func001C()) then
        DisplayTextToForce(GetPlayersAll(), ("Lower hell reviving: " .. GetHeroProperName(udg_TempUnit)))
        udg_TempLoc = GetUnitLoc(udg_TempUnit)
        ReviveHeroLoc(udg_TempUnit, udg_TempLoc, false)
                RemoveLocation(udg_TempLoc)
    else
    end
    udg_TempLoc = GetRectCenter(gg_rct_HeroInit)
        SetUnitPosition(udg_TempUnit, GetLocationX(udg_TempLoc), GetLocationY(udg_TempLoc))
        RemoveLocation(udg_TempLoc)
    PauseUnitBJ(true, udg_TempUnit)
end

function InitTrig_Revive_and_Move_Unit_to_HeroInit()
    gg_trg_Revive_and_Move_Unit_to_HeroInit = CreateTrigger()
    TriggerAddAction(gg_trg_Revive_and_Move_Unit_to_HeroInit, Trig_Revive_and_Move_Unit_to_HeroInit_Actions)
end

function Trig_Lower_Hell_Saga_Timer_Expire_Actions()
    udg_TempUnit = udg_LowerHellSagaUnit[udg_LowerHellSagaCurrentIndex]
    ReviveHeroLoc(udg_TempUnit, udg_LowerHellSagaLoc, false)
        SetUnitPosition(udg_TempUnit, GetLocationX(udg_LowerHellSagaLoc), GetLocationY(udg_LowerHellSagaLoc))
    PauseUnitBJ(false, udg_TempUnit)
    SetUnitLifePercentBJ(udg_TempUnit, 100)
    DisplayTextToForce(GetPlayersAll(), (GetHeroProperName(udg_TempUnit) .. " has returned in the Lower Hells!"))
end

function InitTrig_Lower_Hell_Saga_Timer_Expire()
    gg_trg_Lower_Hell_Saga_Timer_Expire = CreateTrigger()
    TriggerRegisterTimerExpireEventBJ(gg_trg_Lower_Hell_Saga_Timer_Expire, udg_LowerHellSagaTimer)
    TriggerAddAction(gg_trg_Lower_Hell_Saga_Timer_Expire, Trig_Lower_Hell_Saga_Timer_Expire_Actions)
end
...
function Trig_Saiyan_Saga_Completion_Actions()
    ...
    DisableTrigger(GetTriggeringTrigger())
    TriggerExecute(gg_trg_Add_Unit_to_Lower_Hell_Saga_Queue)
    TriggerSleepAction(5.00)
    TriggerExecute(gg_trg_Saiyan_Saga_Creep_Upgrade)
...
function Trig_Transformations_Init_Commands_Actions()
    ...
    udg_TempInt = (udg_TempInt + 1)
    udg_TransformationCommands[udg_TempInt] = "red"
    udg_TempInt = (udg_TempInt + 1)
    udg_TransformationCommands[udg_TempInt] = "blue"
    udg_TempInt = (udg_TempInt + 1)
...
function Trig_Oozaru_Vegeta_Conditions()
...
function Trig_Oozaru_Vegeta_Actions()
    udg_StatMultUnit = GetTriggerUnit()
    TriggerExecute(gg_trg_Get_Stat_Multiplier)
        udg_ID = GetHandleId(udg_StatMultUnit)
    if (Trig_Oozaru_Vegeta_Func004C()) then
...
function InitTrig_Oozaru_Vegeta()
    gg_trg_Oozaru_Vegeta = CreateTrigger()
    TriggerRegisterAnyUnitEventBJ(gg_trg_Oozaru_Vegeta, EVENT_PLAYER_UNIT_SPELL_EFFECT)
    TriggerAddCondition(gg_trg_Oozaru_Vegeta, Condition(Trig_Oozaru_Vegeta_Conditions))
    TriggerAddAction(gg_trg_Oozaru_Vegeta, Trig_Oozaru_Vegeta_Actions)
end
...
function Trig_Transformations_Cooler_Final_Form_Func010C()
    ...
    if (not (IsUnitDeadBJ(udg_StatMultUnit) == true)) then
        return false
    end
    return true
end
...
function InitCustomTriggers()
    ...
    InitTrig_Hero_Enters_Lower_Hell_Respawn()
    InitTrig_Add_Unit_to_Lower_Hell_Saga_Queue()
    InitTrig_Lower_Hell_Saga_Unit_Dies()
    InitTrig_Revive_and_Move_Unit_to_HeroInit()
    InitTrig_Lower_Hell_Saga_Timer_Expire()
