...
function InitSounds()
    ...
    SetSoundDuration(gg_snd_Dlc_rick_and_morty_announcer_01_never_seen_a_mode_like_this, 571)
    ...
    SetSoundDuration(gg_snd_Dlc_rick_and_morty_announcer_02_crazy_old_mode, 571)
    ...
    SetSoundDuration(gg_snd_Dlc_rick_and_morty_announcer_03_out_of_control_mode, 571)
    ...
    SetSoundDuration(gg_snd_Dlc_rick_and_morty_announcer_all_random_01, 571)
    ...
    SetSoundDuration(gg_snd_Dlc_rick_and_morty_announcer_all_random_02, 571)
    ...
    SetSoundDuration(gg_snd_Dlc_rick_and_morty_announcer_captains_mode_03, 571)
    ...
    SetSoundDuration(gg_snd_Dlc_rick_and_morty_announcer_single_draft_01, 571)
    ...
    SetSoundDuration(gg_snd_Dlc_rick_and_morty_announcer_single_draft_02, 571)
    ...
    SetSoundDuration(gg_snd_Dlc_rick_and_morty_announcer_all_pick_01, 571)
    ...
    SetSoundDuration(gg_snd_Dlc_rick_and_morty_announcer_all_pick_03, 571)
...
function Trig_Transformations_Future_Trunks_Func016C()
    if (not Trig_Transformations_Future_Trunks_Func016Func001C()) then
        return false
    end
    return true
end
