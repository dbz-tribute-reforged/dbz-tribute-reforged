...
export module SagaAbilities {
  ...
  export module Beerus {
    export const SPHERE_OF_DESTRUCTION = new SagaAbility(
      AbilityNames.Saga.SPHERE_OF_DESTRUCTION_CUSTOM, 10, 25, 10, MEDIUM_CAST_TIME
    );
    export const AURA_OF_DESTRUCTION = new SagaAbility(
      AbilityNames.Beerus.AURA_OF_DESTRUCTION, 10, 21, 20, MEDIUM_CAST_TIME
    );
    export const BEERUS_SUSHI = new SagaAbility(
      AbilityNames.Beerus.BEERUS_SUSHI, 1, 60, 5, SHORT_CAST_TIME
    );
    export const BEERUS_TAKOYAKI = new SagaAbility(
