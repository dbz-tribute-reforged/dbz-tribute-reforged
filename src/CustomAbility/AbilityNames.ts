export module AbilityNames {
  ...
  export module Piccolo {
    export const SPECIAL_BEAM_CANNON: string = "Special Beam Cannon";
  ...
  export module Pan {
    ...
    export const SUMMON_GIRU: string = "Summon Giru";
  }

  export module Android17DBS {
    export const POWER_BLITZ: string = "Power Blitz";
    export const POWER_BLITZ_BARRAGE: string = "Power Blitz Barrage";
    export const BARRIER_PRISON: string = "Barrier Prison";
    export const BARRIER_WALL: string = "Barrier Wall";
    export const ANDROID_BARRIER: string = "Android Barrier";
  ...
  export module YamchaR {
    export const LIGHT_PUNCH: string = "Light Punch!";
  ...
  export module Guts {
    ...
    export const BURSTING_FLAME: string = "Guts Bursting Flame";
    ...
    export const DRAGON_CANNON_SHOT: string = "Guts Dragon Cannon Shot";
  ...
  export module Babidi {
    ...
    export const BABIDI_MAGIC: string = "Babidi's Magic";
    export const SUMMON_PUI_PUI: string = "Summon Pui Pui";
    export const SUMMON_YAKON: string = "Summon Yakon";
  ...
  export module Android13 {
    ...
    export const NUKE: string = "Nuke";
    export const ANDROID_BARRIER: string = AbilityNames.Android17DBS.ANDROID_BARRIER;
    export const OVERCHARGE: string = "Overcharge";
  }

  export module Broly {
    export const ENERGY_PUNCH: string = "Energy Punch";
    export const POWER_LEVEL_RISING: string = "Power Level Rising";
    export const PLANET_CRUSHER: string = "Planet Crusher";
    export const GIGANTIC_ROAR: string = "Gigantic Roar";
    export const GIGANTIC_OMEGASTORM: string = "Gigantic Omegastorm";
  }
  ...
  export module Cooler {
    ...
    export const DEAFENING_WAVE: string = "Deafening Wave";
    export const GETI_STAR_REPAIR: string = "Geti Star Repair";
  }

  export module Raditz {
    export const DOUBLE_SUNDAY: string = "Double Sunday";
  ...
  export module Moro {
    export const ENERGY_DRAIN: string = "Energy Drain Moro";
    export const ENERGY_BALL: string = "Energy Ball Moro";
    export const LAVA_BURST: string = "Lava Burst";
    export const LAVA_PILLARS: string = "Lava Pillars";
    export const POWER_LEVEL_SHARING: string = "Power Level Sharing";
  }
