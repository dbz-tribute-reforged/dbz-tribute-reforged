...
export const MultiComponents = [
  ...
  // -------------------------------------------
  {
    ...
    replaceSourceWithTargetUnit: true,
    useLastCastPoint: true,
    whichTargetPoint: MultiComponent.TARGET_POINT_TARGET,
    sfxList: true,
    components: [
  ...
  // -------------------------------------------
  {
    ...
    fixedSourceCoords: false,
    fixedReplacementCoords: false,
    targetSource: MultiComponent.SOURCE_SPAWNED_BEAM,
    replaceSourceWithTargetUnit: false,
    useLastCastPoint: true,
    whichTargetPoint: MultiComponent.TARGET_POINT_TARGET,
    sfxList: true,
  ...
  // // -------------------------------------------
  // {
  //   name: "multi beam leon rocket launcher", 
  //   repeatInterval: 1, 
  //   startTick: 0,
  //   endTick: -1,
  //   angleDifference: 1,
  ...
  // -------------------------------------------
  {
    ...
    components: [
      ...
      { name: "debuff slow genos machine gun blows" },
  ...
  // -------------------------------------------
  {
    ...
    components: [
      ...
      { name: "sfx cheong myeong sword of six elements" },
    ],
  },
  // -------------------------------------------
  {
    name: "multi cheong myeong plum blossom palisade branch 1", 
    repeatInterval: 1, 
    startTick: 4,
    endTick: -1,
    angleDifference: 150,
  ...
  // -------------------------------------------
  {
    name: "multi cheong myeong plum blossom palisade branch 1 half", 
    repeatInterval: 1, 
    startTick: 12,
    endTick: -1,
    angleDifference: 120,
  ...
  // -------------------------------------------
  {
    name: "multi cheong myeong plum blossom palisade branch 1 quarter", 
    repeatInterval: 1, 
    startTick: 20,
    endTick: -1,
    angleDifference: 90,
  ...
  // -------------------------------------------
  {
    name: "multi cheong myeong plum blossom palisade branch 2", 
    repeatInterval: 1, 
    startTick: 28,
    endTick: -1,
    angleDifference: 60,
  ...
  // -------------------------------------------
  {
    ...
    angleMin: 0,
    angleMax: 0,
    forceMinDistance: 5000,
    forceMaxDistance: 0,
    delayBetweenComponents: 0,
    firingMode: MultiComponent.LINEAR_FIRING,
    multiplyComponents: 1,
    componentsAddedPerRound: 5,
    alwaysUpdateAngle: false,
    fixedSourceCoords: false,
    fixedReplacementCoords: false,
    targetSource: MultiComponent.SOURCE_CASTER,
  ...
  // -------------------------------------------
  {
    ...
    components: [
      ...
      { name: "debuff slow omniman slice" },
    ],
  },
  // -------------------------------------------
  {
  ...
  // -------------------------------------------
  {
    ...
    components: [
      ...
      { name: "debuff slow omniman impale" },
      { name: "sfx omniman impale" },
    ],
  },
  // -------------------------------------------
  {
    ...
    angleMin: 0,
    angleMax: 1,
    forceMinDistance: 900,
    forceMaxDistance: 900,
    delayBetweenComponents: 10,
    firingMode: MultiComponent.LINEAR_FIRING,
    multiplyComponents: 7,
    componentsAddedPerRound: 1,
    alwaysUpdateAngle: false,
    fixedSourceCoords: true,
    fixedReplacementCoords: false,
