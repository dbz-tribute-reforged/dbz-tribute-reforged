...
// --------------------------------------------
  ...
  { 
    ...
    endTick: -1,
    sfxSource: SfxComponent.SOURCE_TARGET_POINT_DYNAMIC,
    sfxYawType: SfxComponent.YAW_SOURCE_UNIT_TO_TARGET,
    useLastCastPoint: true,
    useHeight: true,
    sfxList: [
      {
  ...
  { 
    ...
    sfxList: [
      {
        model: "Units/NightElf/Wisp/WispExplode.mdl",
        repeatInterval: 0,
        group: 0,
        scale: 6,
        endScale: -1,
  ...
  { 
    ...
    sfxList: [
      {
        model: "CellMaxExplosiveScream.mdl",
        repeatInterval: 1,
        group: 0,
        scale: 7.0,
        endScale: -1,
  ...
  { 
    ...
    sfxList: [
      {
        model: "units/undead/Skeleton/Skeleton.mdl",
        repeatInterval: 1,
        group: 0,
        scale: 3,
        endScale: -1,
      ...
      {
        model: "buildings/undead/TempleOfTheDamned/TempleOfTheDamned.mdl",
        repeatInterval: 0,
        group: 0,
        scale: 1.25,
        endScale: -1,
  ...
  { 
    ...
    attachedSfxList: [
      {
        model: "Abilities/Spells/NightElf/BattleRoar/RoarTarget.mdl",
        repeatInterval: 0,
        group: 0,
        scale: 1,
        endScale: -1,
  ...
  { 
    ...
    sfxList: [
      ...
      {
        model: "Abilities/Spells/Orc/SpikeBarrier/SpikeBarrier.mdl",
        repeatInterval: 1,
        group: 0,
        scale: 1.0,
        endScale: 3.5,
  ...
  { 
    ...
    sfxList: [
      ...
      {
        model: "Abilities/Spells/Undead/Impale/ImpaleMissTarget.mdl",
        repeatInterval: 33,
        group: 0,
        scale: 3.0,
        endScale: -1,
  ...
  { 
    ...
    sfxList: [
      ...
      {
        model: "Abilities/Spells/Undead/UnholyFrenzyAOE/UnholyFrenzyAOETarget.mdl",
        repeatInterval: 132,
        group: 0,
        scale: 6,
        endScale: -1,
  ...
  { 
    ...
    sfxList: [
      {
        model: "Abilities/Spells/Orc/AncestralSpirit/AncestralSpiritCaster.mdl",
        repeatInterval: 33,
        group: 0,
        scale: 1.0,
        endScale: 2.0,
  ...
  { 
    ...
    sfxList: [
      ...
      {
        model: "Doodads/Cinematic/DemonFootPrint/DemonFootPrint0.mdl",
        repeatInterval: 166,
        group: 0,
        scale: 1.5,
        endScale: -1,
  ...
  // --------------------------------------------
  { 
    name: "sfx majin vegeta final flash caster aoe", 
    repeatInterval: 1,
    startTick: 0,
    endTick: 40,
    sfxSource: SfxComponent.SOURCE_TARGET_POINT_DYNAMIC,
  ...
  { 
    ...
    sfxList: [
      {
        model: "ValkSpiritBombCharge.mdl",
        repeatInterval: 0,
        group: 0,
        scale: 2.0,
        endScale: -1,
  ...
  // --------------------------------------------
  { 
    name: "sfx majin vegeta final explosion caster aoe", 
    repeatInterval: 1,
    startTick: 0,
    endTick: 99,
    sfxSource: SfxComponent.SOURCE_TARGET_POINT_DYNAMIC,
  ...
  { 
    ...
    attachedSfxList: [
      {
        model: "Abilities/Spells/Items/ScrollOfRegeneration/Scroll_Regen_Target.mdl",
        repeatInterval: 0,
        group: 0,
        scale: 1.0,
        endScale: -1,
  ...
  { 
    ...
    sfxList: [
      {
        model: "MightGuyHirudoraHead.mdl",
        repeatInterval: 1,
        group: 0,
        scale: 4,
        endScale: -1,
      ...
      {
        model: "MightGuyHirudoraTail.mdl",
        repeatInterval: 3,
        group: 0,
        scale: 2,
        endScale: -1,
  ...
  // --------------------------------------------
  { 
    name: "sfx genos machine gun blows", 
    repeatInterval: 1,
    startTick: 0,
    endTick: -1,
    sfxSource: SfxComponent.SOURCE_TARGET_POINT_DYNAMIC,
  ...
  { 
    ...
    sfxList: [
      ...
      {
        model: "ImpactGroundRocksCircular.mdl",
        repeatInterval: -1,
        group: 0,
        scale: 1.0,
        endScale: -1,
  ...
  { 
    ...
    sfxList: [
      {
        model: "Abilities/Spells/NightElf/TrueshotAura/TrueshotAura.mdl",
        repeatInterval: 1,
        group: 0,
        scale: 5.0,
        endScale: -1,
