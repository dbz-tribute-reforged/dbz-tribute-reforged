...
export const AOEHealComponents = [
  ...
  // robo heal beam
  {
    ...
    canHealCaster: true,
    maxHealTicks: 40,
    healMult: BASE_DMG.KAME_DPS * 0.3,
    healAttribute: bj_HEROSTAT_INT,
  ...
  // hirudegarn molting
  {
    ...
    canHealCaster: true,
    maxHealTicks: AOEHeal.UNLIMITED_HEAL_TICKS,
    healMult: BASE_DMG.KAME_DPS * 0.19,
    healAttribute: bj_HEROSTAT_INT,
  ...
  // peco princess force
  {
    ...
    canHealCaster: true,
    maxHealTicks: 1,
    healMult: BASE_DMG.DFIST_EXPLOSION * 10,
    healAttribute: bj_HEROSTAT_STR,
