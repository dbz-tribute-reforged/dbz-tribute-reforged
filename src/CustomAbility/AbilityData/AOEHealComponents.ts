...
export const AOEHealComponents = [
  ...
  // robo heal beam
  {
    ...
    canHealCaster: true,
    maxHealTicks: 10,
    healMult: BASE_DMG.KAME_DPS * 2.5,
    healAttribute: bj_HEROSTAT_INT,
  ...
  // hirudegarn molting
  {
    ...
    canHealCaster: true,
    maxHealTicks: AOEHeal.UNLIMITED_HEAL_TICKS,
    healMult: BASE_DMG.KAME_DPS * 0.135,
    healAttribute: bj_HEROSTAT_INT,
    maxHealthHealPercent: 0.00012,
    requireBuff: false,
    buffId: 0,
  },
  // schala magic orbs
  ...
  // peco princess force
  {
    ...
    canHealCaster: true,
    maxHealTicks: 1,
    healMult: BASE_DMG.DFIST_EXPLOSION * 12,
    healAttribute: bj_HEROSTAT_STR,
